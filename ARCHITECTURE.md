...
Same test code. No commits. Just environment variables. Different teams can run the same tests against their own environments without touching code. This is crucial when multiple teams share a test framework.
